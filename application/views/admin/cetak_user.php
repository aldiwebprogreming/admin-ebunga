...
table tr:nth-child(even) {
    background:#F0F8FF;
		...
		<img src="logo/logo1.png" style='height: 100px; position: absolute; bottom: 50px; left:50 px; top:30px;'>

		<h3 style="text-align: center; margin-bottom: 60px;">LAPORAN DATA USER</h3>
